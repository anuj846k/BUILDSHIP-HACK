...
import { analyzeThroughBuildship } from "@/lib/buildship.services";
        ...
        for (let i = 0; i < data.length; i += batchSize) {
          ...
          const analysisPromises = batch.map(async (call) => {
            try {
              ...
              try {
                // Try Buildship first
                analysis = await analyzeThroughBuildship({
                ...
                // Fall back to Gemini if Buildship fails
                console.log("Falling back to Gemini analysis due to Buildship error");
